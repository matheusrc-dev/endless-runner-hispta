...
function setup() {
  ...
  troll = new Inimigo(matrizTroll, imagemTroll, width, 0, 200, 200, 400, 400,10, 1500);
  inimigoVoador = new Inimigo(matrizInimigoVoador, imagemInimigoVoador, width - 52, 250, 100, 75, 200, 150, 10, 2500);
  frameRate(40)
  somDoJogo.loop();
